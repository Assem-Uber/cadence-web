...
import { cssStyles, overrides } from './schedule-detail-page-header.styles';
import { type Props } from './schedule-detail-page-header.types';

export default function ScheduleDetailPageHeader({
  domain,
  cluster,
  scheduleId,
}: Props) {
